...
from model_SICH_FT_transformer import StageTranNet
...
def parse_arguments(parser):
    ...
    parser.add_argument('--rnn_dim', type=int, default=100, help='Dimension of hidden units in RNN')
...
if __name__ == '__main__':
    ...
    if args.test_mode == 1:
        ...
        for train, val in kf.split(train_data):
            ...
            #model = torch.load('model/clean_tran_100ep.pt')
