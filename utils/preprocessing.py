...
class Discretizer:
    ...
    def transform(self, X, header=None, end=None):
        ...
        N_channels = len(self._id_to_channel) # which should be 17
        ...
        def write(data, bin_id, channel, value, begin_pos):
            ...
            if self._is_categorical_channel[channel]:                     # transform categorical channel into one-hot format information
                ...
                N_values = len(self._possible_values[channel])            # decide the total length of one-hot
        ...
        for row in X:                                                     # fill out all the existing data
            ...
            assert 0 <= bin_id < N_bins                                   # normal check
